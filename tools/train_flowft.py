...
results = model.train(data="config/dataset_dev/task1_train2.yaml",cfg="config/train/orige_stream_noval.yaml", batch=14*2, epochs=12, imgsz=896, device=device,workers = 6)
