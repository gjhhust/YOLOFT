...
results = model.train(data="config/dataset_dev/Train_gaode5_Test_gaode6.yaml",cfg="config/train/orige_stream.yaml", batch=8, epochs=21, imgsz=896, device=device,workers = 6)
