...
CFG_FLOAT_KEYS = 'warmup_epochs', 'box', 'cls', 'dfl', "homo", 'degrees',"mov", 'shear',"wasserstein_loss",'cpt_loss'
CFG_FRACTION_KEYS = ('dropout', 'iou', 'lr0', 'lrf', 'momentum', 'weight_decay', 'warmup_momentum', 'warmup_bias_lr',
                     'label_smoothing', 'hsv_h', 'hsv_s', 'hsv_v', 'translate', 'scale', 'perspective', 'flipud',
                     'fliplr', 'mosaic', 'mixup', 'copy_paste', 'conf', 'iou', 'fraction',"move")  # fraction floats 0.0 - 1.0
CFG_INT_KEYS = ('epochs', 'patience', 'batch', 'workers', 'seed', 'close_mosaic', 'mask_ratio', 'max_det', 'vid_stride',
                'line_width', 'workspace', 'nbs', 'save_period', "val_interval")
...
def check_dict_alignment(base: Dict, custom: Dict, e=None):
    ...
    if mismatched:
        if len(mismatched) == 1 and mismatched[0] == "save_dir":
            return
        string = ''
        for x in mismatched:
