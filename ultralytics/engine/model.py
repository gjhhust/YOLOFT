...
class Model:
    ...
    def val(self, data=None, validator=None, **kwargs):
        ...
        overrides['mode'] = 'val'
        args = get_cfg(cfg=DEFAULT_CFG, overrides=overrides) if "cfg" not in overrides else get_cfg(cfg=overrides["cfg"], overrides=overrides)
